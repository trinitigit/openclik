...
#define iPhone5 (IS_IPHONE && ([[UIScreen mainScreen] bounds].size.height == 568.0 || [[UIScreen mainScreen] bounds].size.width == 568.0) )
#define iPhone6 (IS_IPHONE && ([[UIScreen mainScreen] bounds].size.height == 667.0 || [[UIScreen mainScreen] bounds].size.width == 667.0) )
#define iPhone6Plus (IS_IPHONE && ([[UIScreen mainScreen] bounds].size.height == 736.0 || [[UIScreen mainScreen] bounds].size.width == 736.0) )
//#define iPhone5 false
@interface OpenClik : NSObject <UIWebViewDelegate,UIWebViewTappingDelegate,UIGestureRecognizerDelegate> {
    ...
    UIVisualEffectView *_visualEffectTopView;
    UIVisualEffectView *_visualEffectBannerView;
    UIVisualEffectView *_visualEffectFullView;
}
...
@property (nonatomic, retain) UIVisualEffectView *visualEffectTopView;
@property (nonatomic, retain) UIVisualEffectView *visualEffectBannerView;
@property (nonatomic, retain) UIVisualEffectView *visualEffectFullView;
