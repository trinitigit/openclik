...
- (void)createAdBannerView {
	...
	NSString *post = [NSString stringWithFormat:@"&action=%@&appId=%@&deviceType=%@&orientationType=%@&sdkver=%@&model=%@&deviceid=%@&systemversion=%@&locale=%@&language=%@&top=%d&installkey=%@&macaddress=%@&iphone5=%@"
					  ,@"httpsShowAd",self.key,self.deviceType,self.OrientationType,OPENCLIKSDKVER,model,deviceid,systemVersion,locale,language,top,installkey,deviceid,iphone5];
...
- (void)fixupAdView:(UIInterfaceOrientation)toInterfaceOrientation {
	...
	{        
			...
			if (_adBannerViewIsVisible && _webADViewIsReady) 
			{
                ...
                _visualEffectView.frame = CGRectMake(0, 0, adBannerViewFrame.size.width, adBannerViewFrame.size.height);
	...
	{        
        ...
        if (_adTopViewIsVisible && _webTopViewIsReady) 
        {
            ...
            [UIView commitAnimations];
            _visualEffectView.frame = CGRectMake(0, 0, adTopViewFrame.size.width, adTopViewFrame.size.height);
	...
	{        
        ...
        if (_adFullViewIsVisible && _webFullViewIsReady)
		{
            ...
            _visualEffectView.frame = CGRectMake(0, 0, adFullViewFrame.size.width, adFullViewFrame.size.height);
